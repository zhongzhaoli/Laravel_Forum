...
function(e) {
    ...
    e.defineMode("css", function(t, r) {
        ...
        function i(e, t) {
            ...
            n("def", e.current())) : "=" == r || ("~" == r || "|" == r) && e.eat("=") ? n(null, "compare") : '"' == r || "'" == r ? (t.tokenize = o(r),
            t.tokenize(e, t)) : "#" == r ? (e.eatWhile(/[\w\\\-]/),
            n("atom", "hash")) : "!" == r ? (e.match(/^\s*\w*/),
            ...
            t.tokenize = a,
            n("property", "word")) : /[\w\\\-]/.test(r) ? (e.eatWhile(/[\w\\\-]/),
            n("property", "word")) : n(null, null) : /[\d.]/.test(e.peek()) ? (e.eatWhile(/[\w.%]/),
            n("number", "unit")) : e.match(/^-[\w\\\-]+/) ? (e.eatWhile(/[\w\\\-]/),
            e.match(/^\s*:/, !1) ? n("variable-2", "variable-definition") : n("variable-2", "variable")) : e.match(/^\w+-/) ? n("meta", "meta") : void 0
        }
        function o(e) {
            return function(t, r) {
        ...
        var m, h, p = t.indentUnit, g = r.tokenHooks, v = r.documentTypes || {}, b = r.mediaTypes || {}, y = r.mediaFeatures || {}, x = r.propertyKeywords || {}, k = r.nonStandardPropertyKeywords || {}, w = r.fontProperties || {}, _ = r.counterDescriptors || {}, C = r.colorKeywords || {}, S = r.valueKeywords || {}, T = r.allowNested, M = {};
        ...
        M.block = function(e, t, r) {
            if ("word" == e) {
                ...
                return x.hasOwnProperty(n) ? (h = "property",
                "maybeprop") : k.hasOwnProperty(n) ? (h = "string-2",
                "maybeprop") : T ? (h = t.match(/^\s*:(?:\s|$)/, !1) ? "property" : "tag",
                "block") : (h += " error",
                "maybeprop")
            }
            return "meta" == e ? "block" : T || "hash" != e && "qualifier" != e ? M.top(e, t, r) : (h = "error",
            "block")
        }
        ,
        ...
        M.propBlock = function(e, t, r) {
            return "}" == e ? c(r) : "word" == e ? (h = "property",
        ...
        M.pseudo = function(e, t, r) {
            return "word" == e ? (h = "variable-3",
            r.context.type) : u(e, t, r)
        }
        ,
        M.atBlock = function(e, t, r) {
            if ("(" == e)
                return l(r, t, "atBlock_parens");
            if ("}" == e)
                return d(e, t, r);
            if ("{" == e)
                return c(r) && l(r, t, T ? "block" : "top");
            if ("word" == e) {
                var n = t.current().toLowerCase();
        ...
        M.restricted_atBlock_before = function(e, t, r) {
            return "{" == e ? l(r, t, "restricted_atBlock") : "word" == e && "@counter-style" == r.stateArg ? (h = "variable",
            "restricted_atBlock_before") : u(e, t, r)
        }
        ,
        M.restricted_atBlock = function(e, t, r) {
            return "}" == e ? (r.stateArg = null,
            c(r)) : "word" == e ? (h = "@font-face" == r.stateArg && !w.hasOwnProperty(t.current().toLowerCase()) || "@counter-style" == r.stateArg && !_.hasOwnProperty(t.current().toLowerCase()) ? "error" : "property",
            "maybeprop") : "restricted_atBlock"
        }
        ,
        M.keyframes = function(e, t, r) {
            return "word" == e ? (h = "variable",
            "keyframes") : "{" == e ? l(r, t, "top") : u(e, t, r)
        }
        ,
        M.at = function(e, t, r) {
            return ";" == e ? c(r) : "{" == e || "}" == e ? d(e, t, r) : ("word" == e ? h = "tag" : "hash" == e && (h = "builtin"),
            "at")
        }
        ,
        M.interpolation = function(e, t, r) {
            return "}" == e ? c(r) : "{" == e || ";" == e ? d(e, t, r) : ("variable" != e && (h = "error"),
            "interpolation")
        }
        ,
        {
            ...
            token: function(e, t) {
                ...
                return r && "object" == typeof r && (m = r[1],
                r = r[0]),
                h = r,
            ...
            indent: function(e, t) {
                ...
                !r.prev || ("}" != n || "block" != r.type && "top" != r.type && "interpolation" != r.type && "restricted_atBlock" != r.type) && (")" != n || "parens" != r.type && "atBlock_parens" != r.type) && ("{" != n || "at" != r.type && "atBlock" != r.type) || (i = r.indent - p,
                r = r.prev),
                i
            },
            electricChars: "}",
...
function(e) {
    ...
    e.defineMode("sass", function(e) {
        ...
        function r(e, t) {
            ...
            "operator") : "(" === r ? (e.next(),
            e.eatSpace(),
            "operator") : "'" === r || '"' === r ? (t.tokenizer = i(e.next()),
            "string") : (t.tokenizer = i(")", !1),
            "string")
        }
        function n(e, t) {
            return function(r, n) {
                return r.sol() && r.indentation() <= e ? (n.tokenizer = l,
                l(r, n)) : (t && r.skipTo("*/") ? (r.next(),
                r.next(),
                n.tokenizer = l) : r.skipToEnd(),
                "comment")
            }
        }
        function i(e, t) {
            function r(n, i) {
                var a = n.next()
                  ...
                  , u = "\\" !== a && s === e || a === e && "\\" !== c;
                return u ? (a !== e && t && n.next(),
                i.tokenizer = l,
                "string") : "#" === a && "{" === s ? (i.tokenizer = o(r),
                n.next(),
                "operator") : "string"
            }
            return null == t && (t = !0),
        ...
        function l(e, t) {
            var c = e.peek();
            if (e.match("/*"))
                return t.tokenizer = n(e.indentation(), !0),
                t.tokenizer(e, t);
            if (e.match("//"))
                return t.tokenizer = n(e.indentation(), !1),
                t.tokenizer(e, t);
            if (e.match("#{"))
                return t.tokenizer = o(l),
                "operator";
            if ('"' === c || "'" === c)
                return e.next(),
                t.tokenizer = i(c),
            ...
            if (t.cursorHalf) {
                ...
                if ("+" === c && e.match(/^\+[\w-]+/))
                    return "variable-3";
                if ("@" === c && e.match(/@extend/) && (e.match(/\s*[\w]/) || s(t)),
                ...
                if ("@" === c)
                    ...
                    "meta";
                if (e.eatWhile(/[\w-]/))
                    return e.match(/ *: *[\w-\+\$#!\("']/, !1) ? "propery" : e.match(/ *:/, !1) ? (a(t),
                    t.cursorHalf = 1,
                    "atom") : e.match(/ *,/, !1) ? "atom" : (a(t),
                    "atom");
                if (":" === c)
                    return e.match(h) ? "keyword" : (e.next(),
                    t.cursorHalf = 1,
                    "operator")
            }
            return e.match(m) ? "operator" : (e.next(),
            null)
        }
        function c(t, r) {
    ...
    e.defineMode("shell", function() {
        ...
        function t(e, t) {
            ...
            if ("\\" === s)
                ...
                null;
            if ("'" === s || '"' === s || "`" === s)
                return t.tokens.unshift(r(s)),
                n(e, t);
            if ("#" === s)
                return a && e.eat("!") ? (e.skipToEnd(),
                "meta") : (e.skipToEnd(),
                "comment");
            if ("$" === s)
                return t.tokens.unshift(o),
                n(e, t);
            if ("+" === s || "=" === s)
                return "operator";
            if ("-" === s)
...
function(e) {
    ...
    e.defineMode("sql", function(t, r) {
        function n(e, t) {
            ...
            if (1 == m.hexNumber && ("0" == r && e.match(/^[xX][0-9a-fA-F]+/) || ("x" == r || "X" == r) && e.match(/^'[0-9a-fA-F]+'/)))
                return "number";
            ...
            if ("'" == r || '"' == r && m.doubleQuote)
                ...
                t.tokenize(e, t);
            if ((1 == m.nCharCast && ("n" == r || "N" == r) || 1 == m.charsetCast && "_" == r && e.match(/[a-z][a-z0-9]*/i)) && ("'" == e.peek() || '"' == e.peek()))
                return "keyword";
            if (/^[\(\),\;\[\]]/.test(r))
                return null;
            if (m.commentSlashSlash && "/" == r && e.eat("/"))
                return e.skipToEnd(),
                "comment";
            if (m.commentHash && "#" == r || "-" == r && e.eat("-") && (!m.commentSpaceRequired || e.eat(" ")))
                return e.skipToEnd(),
                "comment";
            if ("/" == r && e.eat("*"))
                return t.tokenize = o,
...
function(e) {
    ...
    function n(e, t) {
        ...
        e.match(/(R|u8R|uR|UR|LR)/)) {
            ...
            return r ? (t.cpp11RawStringDelim = r[1],
            t.tokenize = o,
            o(e, t)) : !1
        }
        return e.match(/(u8|u|U|L)/) ? e.match(/["']/, !1) ? "string" : !1 : (e.next(),
        !1)
    }
    function i(e, t) {
    ...
    e.defineMode("clike", function(t, r) {
        function n(e, t) {
            ...
            e.eatWhile(/[\w\$_\xa1-\uffff]/);
            var a = e.current();
            return m.propertyIsEnumerable(a) ? (p.propertyIsEnumerable(a) && (c = "newstatement"),
            "keyword") : h.propertyIsEnumerable(a) ? (p.propertyIsEnumerable(a) && (c = "newstatement"),
            "builtin") : g.propertyIsEnumerable(a) ? "atom" : "variable"
        }
        function i(e) {
            return function(t, r) {
        ...
        var c, u = t.indentUnit, d = r.statementIndentUnit || u, f = r.dontAlignCalls, m = r.keywords || {}, h = r.builtin || {}, p = r.blockKeywords || {}, g = r.atoms || {}, v = r.hooks || {}, b = r.multiLineStrings, y = r.indentStatements !== !1, x = /[+\-*&%=<>!?|\/]/;
        return {
            startState: function(e) {
                return {
                    tokenize: null,
            ...
            token: function(e, t) {
                ...
                ";" != c && ":" != c && "," != c || "statement" != r.type)
                    if ("{" == c)
                        ...
                        c == r.type ? l(t) : y && (("}" == r.type || "top" == r.type) && ";" != c || "statement" == r.type && "newstatement" == c) && s(t, e.column(), "statement");
                else
                    l(t);
            ...
            indent: function(t, r) {
                if (t.tokenize != n && null != t.tokenize)
                    return e.Pass;
                var i = t.context
                  , o = r && r.charAt(0);
    ...
    a("text/x-csharp", {
        ...
        hooks: {
            "@": function(e, t) {
                return e.eat('"') ? (t.tokenize = i,
                i(e, t)) : (e.eatWhile(/[\w\$_]/),
                "meta")
            }
        }
    }),
...
function(e) {
    ...
    function r(e, t) {
        return 0 == e.length ? n(t) : function(i, o) {
            for (var a = e[0], s = 0; s < a.length; s++)
                if (i.match(a[s][0]))
                    return o.tokenize = r(e.slice(1), t),
                    a[s][1];
    ...
    function i(e, t, n) {
        ...
        if (e.match(/^\$[a-zA-Z_][a-zA-Z0-9_]*/))
            return e.match("[", !1) && (t.tokenize = r([[["[", null]], [[/\d[\w\.]*/, "number"], [/\$[a-zA-Z_][a-zA-Z0-9_]*/, "variable-2"], [/[\w\$]+/, "variable"]], [["]", null]]], n)),
        ...
        hooks: {
            ...
            "<": function(e, t) {
                if (e.match(/<</)) {
                    ...
                    if (r)
                        return (t.tokStack || (t.tokStack = [])).push(r, 0),
                        t.tokenize = n(r),
                        "string"
                }
                return !1
    ...
    e.defineMode("php", function(t, r) {
        function n(e, t) {
            var r = t.curMode == o;
            if (e.sol() && t.pending && '"' != t.pending && "'" != t.pending && (t.pending = null),
            r)
                return r && null == t.php.tokenize && e.match("?>") ? (t.curMode = i,
                t.curState = t.html,
                "meta") : o.token(e, t.curState);
            if (e.match(/^<\?\w*/))
                return t.curMode = o,
                t.curState = t.php,
                "meta";
...
function(e) {
    ...
    e.defineMode("xml", function(t, r) {
        function n(e, t) {
            ...
            var n = e.next();
            if ("<" == n)
                return e.eat("!") ? e.eat("[") ? e.match("CDATA[") ? r(a("atom", "]]>")) : null : e.match("--") ? r(a("comment", "-->")) : e.match("DOCTYPE", !0, !0) ? (e.eatWhile(/[\w\._\-]/),
                r(s(1))) : null : e.eat("?") ? (e.eatWhile(/[\w\._\-]/),
                t.tokenize = a("meta", "?>"),
                "meta") : (_ = e.eat("/") ? "closeTag" : "openTag",
                t.tokenize = i,
                "tag bracket");
            if ("&" == n) {
                var o;
        ...
        function u(e, t) {
            for (var r; ; ) {
                if (!e.context)
                    return;
                if (r = e.context.tagName,
                !S.contextGrabbers.hasOwnProperty(r) || !S.contextGrabbers[r].hasOwnProperty(t))
                    return;
                c(e)
            }
        }
        function d(e, t, r) {
            return "openTag" == e ? (r.tagStart = t.column(),
            f) : "closeTag" == e ? m : d
        }
        function f(e, t, r) {
            return "word" == e ? (r.tagName = t.current(),
            C = "tag",
            g) : (C = "error",
            f)
        }
        function m(e, t, r) {
            if ("word" == e) {
                ...
                r.context && r.context.tagName == n ? (C = "tag",
                h) : (C = "tag error",
                p)
            }
            return C = "error",
        ...
        function g(e, t, r) {
            ...
            if ("endTag" == e || "selfcloseTag" == e) {
                ...
                "selfcloseTag" == e || S.autoSelfClosers.hasOwnProperty(n) ? u(r, n) : (u(r, n),
        ...
        function v(e, t, r) {
            return "equals" == e ? b : (S.allowMissing || (C = "error"),
            g(e, t, r))
        }
        function b(e, t, r) {
            return "string" == e ? y : "word" == e && S.allowUnquoted ? (C = "string",
            g) : (C = "error",
            g(e, t, r))
        }
        function y(e, t, r) {
...
function(e) {
    ...
    e.defineMode("markdown", function(t, r) {
        ...
        function s(e, t) {
            var o = e.sol()
              , a = t.list !== !1;
            t.list !== !1 && t.indentationDiff >= 0 ? (t.indentationDiff < 4 && (t.indentation -= t.indentationDiff),
            t.list = null) : t.list !== !1 && t.indentation > 0 ? (t.list = null,
            t.listDepth = Math.floor(t.indentation / 4)) : t.list !== !1 && (t.list = !1,
            t.listDepth = 0);
            var s = null;
            if (t.indentationDiff >= 4)
                return t.indentation -= 4,
                e.skipToEnd(),
                S;
            if (e.eatSpace())
                return null;
            if (s = e.match(U))
                return t.header = s[0].length <= 6 ? s[0].length : 6,
                r.highlightFormatting && (t.formatting = "header"),
                t.f = t.inline,
                d(t);
            if (t.prevLineHasContent && (s = e.match(W)))
                return t.header = "=" == s[0].charAt(0) ? 1 : 2,
                r.highlightFormatting && (t.formatting = "header"),
                t.f = t.inline,
                d(t);
            if (e.eat(">"))
            ...
            if ((!t.prevLineHasContent || a) && (e.match(H, !1) || e.match(N, !1))) {
                var l = null;
                return e.match(H, !0) ? l = "ul" : (e.match(N, !0),
                l = "ol"),
                t.indentation += 4,
                t.list = !0,
                t.listDepth++,
            ...
            return r.fencedCodeBlocks && e.match(/^```[ \t]*([\w+#]*)/, !0) ? (t.localMode = n(RegExp.$1),
        ...
        function l(e, t) {
            ...
            return (k && null === t.htmlState.tagStart && !t.htmlState.context || t.md_inside && e.current().indexOf(">") > -1) && (t.f = m,
            t.block = s,
            t.htmlState = null),
            r
        }
        function c(e, t) {
            return e.sol() && e.match("```", !1) ? (t.localMode = t.localState = null,
            t.f = t.block = u,
        ...
        function d(e) {
            ...
            t.push(C + "-" + e.header)),
            e.quote && (t.push(T),
            t.push(!r.maxBlockquoteDepth || r.maxBlockquoteDepth >= e.quote ? T + "-" + e.quote : T + "-" + r.maxBlockquoteDepth)),
            e.list !== !1) {
        ...
        function m(t, n) {
            ...
            n.taskClosed = !1,
            n.header && t.match(/^#+$/, !0))
                return r.highlightFormatting && (n.formatting = "header"),
                d(n);
            var s = t.sol()
              , c = t.next();
            if ("\\" === c && (t.next(),
          ...
          , Z = {
            ...
            token: function(e, t) {
                ...
                e.sol()) {
                    ...
                    if (t.indentationDiff = o - t.indentation,
                    t.indentation = o,
                    n > 0)
                        return null
                }
    ...
    e.defineMode("javascript", function(t, r) {
        ...
        function o(e, t) {
            ...
            if ("/" == r)
                ...
                i("comment", "comment")) : "operator" == t.lastType || "keyword c" == t.lastType || "sof" == t.lastType || /^[\[{}\(,;:]$/.test(t.lastType) ? (n(e),
                e.match(/^\b(([gimyu])(?![gimyu]*\2))+\b/),
                i("regexp", "string-2")) : (e.eatWhile(Ce),
        ...
        function k(e, t) {
            return "var" == e ? h(b("vardef", t.length), B, x(";"), y) : "keyword a" == e ? h(b("form"), w, k, y) : "keyword b" == e ? h(b("form"), k, y) : "{" == e ? h(b("}"), F, y) : ";" == e ? h() : "if" == e ? ("else" == Le.state.lexical.info && Le.state.cc[Le.state.cc.length - 1] == y && Le.state.cc.pop()(),
            h(b("form"), w, k, y, Z)) : "function" == e ? h(ee) : "for" == e ? h(b("form"), G, k, y) : "variable" == e ? h(b("stat"), I) : "switch" == e ? h(b("form"), w, b("}", "switch"), x("{"), F, y, y) : "case" == e ? h(w, x(":")) : "default" == e ? h(x(":")) : "catch" == e ? h(b("form"), g, x("("), te, x(")"), k, y, v) : "module" == e ? h(b("form"), g, ae, v, y) : "class" == e ? h(b("form"), re, y) : "export" == e ? h(b("form"), se, y) : "import" == e ? h(b("form"), le, y) : m(b("stat"), w, x(";"), y)
        }
        function w(e) {
            return C(e, !1)
        }
        ...
        function P(e) {
            return "variable" == e ? (Le.marked = "property",
            h()) : void 0
        }
        function D(e, t) {
            return "variable" == e || "keyword" == Le.style ? (Le.marked = "property",
            h("get" == t || "set" == t ? A : $)) : "number" == e || "string" == e ? (Le.marked = ye ? "property" : Le.style + " property",
            h($)) : "jsonld-keyword" == e ? h($) : "[" == e ? h(w, x("]"), $) : void 0
        }
        function A(e) {
            return "variable" != e ? m($) : (Le.marked = "property",
            h(ee))
        }
        function $(e) {
        ...
        function N(e) {
            return "variable" == e ? (Le.marked = "variable-3",
            h()) : void 0
        }
        function B() {
            return m(U, H, V, K)
        ...
        function U(e, t) {
            return "variable" == e ? (p(t),
            h()) : "[" == e ? R(U, "]") : "{" == e ? R(W, "}") : void 0
        }
        function W(e, t) {
            return "variable" != e || Le.stream.match(/^\s*:/, !1) ? ("variable" == e && (Le.marked = "property"),
            h(x(":"), U, V)) : (p(t),
            h(V))
        }
        function V(e, t) {
        ...
        function Q(e, t) {
            return "in" == t || "of" == t ? (Le.marked = "keyword",
            h(w)) : h(M, Y)
        }
        function Y(e, t) {
            return ";" == e ? h(J) : "in" == t || "of" == t ? (Le.marked = "keyword",
            h(w)) : m(w, x(";"), J)
        }
        function J(e) {
            ")" != e && h(w)
        ...
        function ee(e, t) {
            return "*" == t ? (Le.marked = "keyword",
            h(ee)) : "variable" == e ? (p(t),
            h(ee)) : "(" == e ? h(g, b(")"), O(te, ")"), y, k, v) : void 0
        }
        function te(e) {
        ...
        function ie(e, t) {
            return "variable" == e || "keyword" == Le.style ? (Le.marked = "property",
            "get" == t || "set" == t ? h(oe, ee, ie) : h(ee, ie)) : "*" == t ? (Le.marked = "keyword",
            h(ie)) : ";" == e ? h(ie) : "}" == e ? h() : void 0
        }
        function oe(e) {
            return "variable" != e ? m() : (Le.marked = "property",
            h())
        ...
        function ae(e, t) {
            return "string" == e ? h(k) : "variable" == e ? (p(t),
            h(ue)) : void 0
        }
        function se(e, t) {
            return "*" == t ? (Le.marked = "keyword",
            h(ue, x(";"))) : "default" == t ? (Le.marked = "keyword",
            h(w, x(";"))) : m(k)
        }
        function le(e) {
        ...
        function ce(e, t) {
            return "{" == e ? R(ce, "}") : ("variable" == e && p(t),
            h())
        }
        function ue(e, t) {
            return "from" == t ? (Le.marked = "keyword",
            h(w)) : void 0
        }
        function de(e) {
            return "]" == e ? h() : m(_, fe)
        ...
        var pe, ge, ve = t.indentUnit, be = r.statementIndent, ye = r.jsonld, xe = r.json || ye, ke = r.typescript, we = r.wordCharacters || /[\w$\xa1-\uffff]/, _e = function() {
            function e(e) {
                return {
                    type: e,
                    style: "keyword"
            ...
            return a
        }(), Ce = /[+\-*&%=<>!?|~^]/, Se = /^@(context|id|value|language|type|container|list|set|reverse|index|base|vocab|graph)"/, Te = "([{}])", Me = {
            atom: !0,
            number: !0,
            variable: !0,
            string: !0,
        ...
        return y.lex = !0,
        {
            ...
            token: function(e, t) {
                ...
                t.tokenize != s && e.eatSpace())
                    return null;
                var r = t.tokenize(e, t);
                return "comment" == pe ? r : (t.lastType = "operator" != pe || "++" != ge && "--" != ge ? pe : "incdec",
                f(t, r, pe, ge, e))
            },
            indent: function(t, n) {
                if (t.tokenize == s)
...
function(e) {
    ...
    e.defineMode("htmlmixed", function(t, r) {
            ...
            if ("script" == r && /\btag\b/.test(n) && ">" == e.current()) {
                ...
                for (var u = 0; u < c.length; ++u) {
                    ...
                    if ("string" == typeof d.matches ? i == d.matches : d.matches.test(i)) {
                        d.mode && (t.token = o,
                        t.localMode = d.mode,
                        t.localState = d.mode.startState && d.mode.startState(s.indent(t.htmlState, "")));
                        break
                    }
                }
            } else
                "style" == r && /\btag\b/.test(n) && ">" == e.current() && (t.token = a,
                t.localMode = l,
        ...
        function i(e, t, r) {
            ...
            return o > -1 ? e.backUp(i.length - o) : (n = i.match(/<\/?$/)) && (e.backUp(i.length),
            e.match(t, !1) || e.match(i)),
            r
        }
        function o(e, t) {
            return e.match(/^<\/\s*script\s*>/i, !1) ? (t.token = n,
            t.localState = t.localMode = null,
            null) : i(e, /<\/\s*script\s*>/, t.localMode.token(e, t.localState))
        }
        function a(e, t) {
            return e.match(/^<\/\s*style\s*>/i, !1) ? (t.token = n,
            t.localState = t.localMode = null,
            null) : i(e, /<\/\s*style\s*>/, l.token(e, t.localState))
        }
        var s = e.getMode(t, {
            name: "xml",
            htmlMode: !0,
    ...
    e.defineMode("gfm", function(t, r) {
        ...
        var i = 0
          , o = {
            ...
            token: function(e, t) {
                if (t.combineTokens = null,
                t.codeBlock)
                    return e.match(/^```/) ? (t.codeBlock = !1,
                    null) : (e.skipToEnd(),
                    null);
                if (e.sol() && (t.code = !1),
                e.sol() && e.match(/^```/))
                ...
                if ("`" === e.peek()) {
                    ...
                    e.eatWhile("`");
                    var n = 1 + e.pos - r;
                    return t.code ? n === i && (t.code = !1) : (i = n,
                    t.code = !0),
                    null
                }
                if (t.code)
                ...
                if (e.sol() || t.ateSpace) {
                    if (t.ateSpace = !1,
                    e.match(/^(?:[a-zA-Z0-9\-_]+\/)?(?:[a-zA-Z0-9\-_]+@)?(?:[a-f0-9]{7,40}\b)/))
                        return t.combineTokens = !0,
                        "link";
                    if (e.match(/^(?:[a-zA-Z0-9\-_]+\/)?(?:[a-zA-Z0-9\-_]+)?#[0-9]+\b/))
                        return t.combineTokens = !0,
                        "link"
                }
                return e.match(/^((?:[a-z][\w-]+:(?:\/{1,3}|[a-z0-9%])|www\d{0,3}[.]|[a-z0-9.\-]+[.][a-z]{2,4}\/)(?:[^\s()<>]|\([^\s()<>]*\))+(?:\([^\s()<>]*\)|[^\s`*!()\[\]{};:'".,<>???¡°¡±¡®¡¯]))/i) && "](" != e.string.slice(e.start - 2, e.start) ? (t.combineTokens = !0,
                "link") : (e.next(),
                null)
            },
            blankLine: n
...
function(e) {
    ...
    e.defineMode("http", function() {
        ...
        function t(t, n) {
            return t.match(/^HTTP\/\d\.\d/) ? (n.cur = r,
            "keyword") : t.match(/^[A-Z]+/) && /[ \t]/.test(t.peek()) ? (n.cur = i,
            "keyword") : e(t, n)
        }
        function r(t, r) {
            var i = t.match(/^\d+/);
        ...
        function o(t, r) {
            return t.match(/^HTTP\/\d\.\d$/) ? (r.cur = a,
            "keyword") : e(t, r)
        }
        function a(e) {
...
function(e) {
    ...
    e.defineMode("go", function(e) {
        function t(e, t) {
            ...
            e.eatWhile(/[\w\$_\xa1-\uffff]/);
            var o = e.current();
            return c.propertyIsEnumerable(o) ? (("case" == o || "default" == o) && (s = "case"),
            "keyword") : u.propertyIsEnumerable(o) ? "atom" : "variable"
        }
        function r(e) {
            return function(r, n) {
        ...
        return {
            ...
            token: function(e, r) {
                ...
                return "comment" == i ? i : (null == n.align && (n.align = !0),
                "{" == s ? o(r, e.column(), "}") : "[" == s ? o(r, e.column(), "]") : "(" == s ? o(r, e.column(), ")") : "case" == s ? n.type = "case" : "}" == s && "}" == n.type ? n = a(r) : s == n.type && a(r),
                r.startOfLine = !1,
                i)
            },
            indent: function(e, r) {
...
function(e) {
    ...
    e.defineMode("coffeescript", function(e, t) {
        ...
        function n(e, t) {
            ...
            if (e.match(b))
                return t.tokenize = i(e.current(), !1, "string"),
                t.tokenize(e, t);
            if (e.match(y)) {
                if ("/" != e.current() || e.match(/^.*\//, !1))
                    return t.tokenize = i(e.current(), !0, "string-2"),
                    t.tokenize(e, t);
                e.backUp(1)
            }
            return e.match(u) || e.match(h) ? "operator" : e.match(d) ? "punctuation" : e.match(k) ? "atom" : e.match(v) ? "keyword" : e.match(f) ? "variable" : e.match(m) ? "property" : (e.next(),
            c)
        }
        function i(e, r, i) {
            return function(o, a) {
        ...
        function a(t, r, n) {
            ...
            "coffee" !== n ? (o = null,
            a = t.column() + t.current().length) : r.scope.align && (r.scope.align = !1),
            r.scope = {
                offset: i,
                type: n,
                prev: r.scope,
        ...
        function l(e, t) {
            var r = t.tokenize(e, t)
              , n = e.current();
            if ("." === n)
                return r = t.tokenize(e, t),
                n = e.current(),
                /^\.[\w$]+$/.test(n) ? "variable" : c;
            "return" === n && (t.dedent = !0),
            ("->" !== n && "=>" !== n || t.lambda || e.peek()) && "indent" !== r || a(e, t);
            var i = "[({".indexOf(n);
            if (-1 !== i && a(e, t, "])}".slice(i, i + 1)),
            p.exec(n) && a(e, t),
            "then" == n && s(e, t),
            "dedent" === r && s(e, t))
                return c;
    ...
    e.defineMode("nginx", function(e) {
        ...
        function n(e, t) {
            ...
            if (u.propertyIsEnumerable(n))
                return "string-2";
            var s = e.next();
            return "@" == s ? (e.eatWhile(/[\w\\\-]/),
            r("meta", e.current())) : "/" == s && e.eat("*") ? (t.tokenize = i,
            i(e, t)) : "<" == s && e.eat("!") ? (t.tokenize = o,
            o(e, t)) : "=" != s ? "~" != s && "|" != s || !e.eat("=") ? '"' == s || "'" == s ? (t.tokenize = a(s),
            t.tokenize(e, t)) : "#" == s ? (e.skipToEnd(),
            r("comment", "comment")) : "!" == s ? (e.match(/^\s*\w*/),
            r("keyword", "important")) : /\d/.test(s) ? (e.eatWhile(/[\w.%]/),
            r("number", "unit")) : /[,.+>*\/]/.test(s) ? r(null, "select-op") : /[;{}:\[\]]/.test(s) ? r(null, s) : (e.eatWhile(/[\w\\\-]/),
    ...
    e.defineMode("python", function(l, c) {
        ...
        function d(e, t) {
            ...
            if (e.match(/^[0-9\.]/, !1)) {
                ...
                i)
                    ...
                    "number";
                var o = !1;
                if (e.match(/^0x[0-9a-f]+/i) && (o = !0),
                e.match(/^0b[01]+/i) && (o = !0),
                e.match(/^0o[0-7]+/i) && (o = !0),
                e.match(/^[1-9]\d*(e[\+\-]?\d+)?/) && (e.eat(/J/i),
                o = !0),
                e.match(/^0(?![\dx])/i) && (o = !0),
                o)
                    return e.eat(/L/i),
            ...
            return e.match(T) ? (t.tokenize = f(e.current()),
            t.tokenize(e, t)) : e.match(x) || e.match(y) ? null : e.match(b) || e.match(k) || e.match(n) ? "operator" : e.match(v) ? null : e.match(M) ? "keyword" : e.match(L) ? "builtin" : e.match(/^(self|cls)\b/) ? "variable-2" : e.match(w) ? "def" == t.lastToken || "class" == t.lastToken ? "def" : "variable" : (e.next(),
            g)
        }
        function f(e) {
            function t(t, i) {
        ...
        function p(e, t) {
            var n = t.tokenize(e, t)
              , i = e.current();
            if ("." == i)
                return n = e.match(w, !1) ? null : g,
                null == n && "meta" == t.lastStyle && (n = "meta"),
                n;
            if ("@" == i)
                return c.version && 3 == parseInt(c.version, 10) ? e.match(w, !1) ? "meta" : "operator" : e.match(w, !1) ? "meta" : g;
        ...
        var _ = c.hangingIndent || l.indentUnit
          , C = i
          , S = o;
        if (void 0 != c.extra_keywords && (C = C.concat(c.extra_keywords)),
    ...
    e.defineMode("perl", function() {
        function e(e, t, r, n, i) {
            ...
            t.tokenize = function(e, t) {
                for (var o, s = !1, l = 0; o = e.next(); ) {
                    if (o === r[l] && !s)
                        return void 0 !== r[++l] ? (t.chain = r[l],
                        t.style = n,
                        t.tail = i) : i && e.eatWhile(i),
                        t.tokenize = a,
                        n;
                    s = !s && "\\" == o
                }
        ...
        function a(a, u) {
            if (a.eatSpace())
                return null;
            if (u.chain)
                return e(a, u, u.chain, u.style, u.tail);
            if (a.match(/^\-?[\d\.]/, !1) && a.match(/^(\-?(\d*\.\d+(e[+-]?\d+)?|\d+\.\d*)|0x[\da-fA-F]+|0b[01]+|\d+(e[+-]?\d+)?)/))
                return "number";
            if (a.match(/^<<(?=\w)/))
                return a.eatWhile(/\w/),
                o(a, u, a.current().substr(2));
            if (a.sol() && a.match(/^\=item(?!\w)/))
                return o(a, u, "=cut");
            var d = a.next();
            if ('"' == d || "'" == d) {
                if (r(a, 3) == "<<" + d) {
            ...
            if ("s" == d) {
                var h = /[\/>\]})\w]/.test(t(a, -2));
                if (!h && (h = a.eat(/[(\[{<\^'"!~\/]/)))
                    return "[" == h ? e(a, u, ["]", "]"], l, c) : "{" == h ? e(a, u, ["}", "}"], l, c) : "<" == h ? e(a, u, [">", ">"], l, c) : "(" == h ? e(a, u, [")", ")"], l, c) : e(a, u, [h, h], l, c)
            }
            if ("y" == d) {
                var h = /[\/>\]})\w]/.test(t(a, -2));
                if (!h && (h = a.eat(/[(\[{<\^'"!~\/]/)))
            ...
            if (/[A-Z]/.test(d)) {
                ...
                !/[\da-z]/.test(t(a, 0))) {
                    var h = s[a.current()];
                    return h ? (h[1] && (h = h[0]),
                    ":" != p ? 1 == h ? "keyword" : 2 == h ? "def" : 3 == h ? "atom" : 4 == h ? "operator" : 5 == h ? "variable-2" : "meta" : "meta") : "meta"
                }
                a.pos = f
            }
            if (/[a-zA-Z_]/.test(d)) {
...
function(e) {
    ...
    e.defineMode("lua", function(e, t) {
        ...
        function o(e, t) {
            ...
            "comment") : '"' == r || "'" == r ? (t.cur = s(r))(e, t) : "[" == r && /[\[=]/.test(e.peek()) ? (t.cur = a(i(e), "string"))(e, t) : /\d/.test(r) ? (e.eatWhile(/[\w.%]/),
            "number") : /[\w_]/.test(r) ? (e.eatWhile(/[\w\\\-_.]/),
            "variable") : null
        }
        function a(e, t) {
            return function(r, n) {
    ...
    e.defineMode("r", function(e) {
        ...
        function r(e, t) {
            ...
            if (/[\w\.]/.test(r) && "_" != r) {
                e.eatWhile(/[\w\.]/);
                var i = e.current();
                return s.propertyIsEnumerable(i) ? "atom" : c.propertyIsEnumerable(i) ? (u.propertyIsEnumerable(i) && !e.match(/\s*if(\s+|$)/, !1) && (a = "block"),
                "keyword") : l.propertyIsEnumerable(i) ? "builtin" : "variable"
            }
            return "%" == r ? (e.skipTo("%") && e.next(),
            "variable-2") : "<" == r && e.eat("-") ? "arrow" : "=" == r && t.ctx.argList ? "arg-is" : d.test(r) ? "$" == r ? "dollar" : (e.eatWhile(d),
            "operator") : /[\(\){}\[\];]/.test(r) ? (a = r,
            ";" == r ? "semi" : null) : null
        }
        function n(e) {
        ...
        var a, s = t("NULL NA Inf NaN NA_integer_ NA_real_ NA_complex_ NA_character_"), l = t("list quote bquote eval return call parse deparse"), c = t("if else repeat while function for in next break"), u = t("if else repeat while function for"), d = /[+\-*\/^<>=!&|~$:]/;
        return {
            startState: function() {
                return {
                    tokenize: r,
            ...
            token: function(e, t) {
                if (e.sol() && (null == t.ctx.align && (t.ctx.align = !1),
                ...
                "{" == a ? i(t, "}", e) : "(" == a ? (i(t, ")", e),
                t.afterIdent && (t.ctx.argList = !0)) : "[" == a ? i(t, "]", e) : "block" == a ? i(t, "block", e) : a == n && o(t),
...
function(e) {
    ...
    e.defineMode("ruby", function(e) {
        ...
        function n(e, t) {
            if (c = null,
            e.sol() && e.match("=begin") && e.eol())
                return t.tokenize.push(l),
                "comment";
            if (e.eatSpace())
                return null;
            var n, i = e.next();
            ...
            if ("/" == i) {
                ...
                if (e.skipTo("/")) {
                    ...
                    if (e.backUp(e.current().length - o),
                    0 == d)
            ...
            if ("%" == i) {
                ...
                p = !1);
                var g = e.eat(/[^\w\s=]/);
                return g ? (m.propertyIsEnumerable(g) && (g = m[g]),
                r(a(g, h, p, !0), e, t)) : "operator"
            }
            if ("#" == i)
                return e.skipToEnd(),
                "comment";
            if ("<" == i && (n = e.match(/^<-?[\`\"\']?([a-zA-Z_?]\w*)[\`\"\']?(?:;|$)/)))
                return r(s(n[1]), e, t);
            if ("0" == i)
                return e.eatWhile(e.eat("x") ? /[\da-fA-F]/ : e.eat("b") ? /[01]/ : /[0-7]/),
                "number";
            if (/\d/.test(i))
            ...
            if (":" == i)
                return e.eat("'") ? r(a("'", "atom", !1), e, t) : e.eat('"') ? r(a('"', "atom", !0), e, t) : e.eat(/[\<\>]/) ? (e.eat(/[\<\>]/),
        ...
        function o() {
            var e = !1;
            return function(t, r) {
                return e ? (r.tokenize.pop(),
                r.tokenize[r.tokenize.length - 1](t, r)) : (e = !0,
                n(t, r))
            }
        }
        function a(e, t, r, n) {
            return function(a, s) {
                var l, c = !1;
                for ("read-quoted-paused" === s.context.type && (s.context = s.context.prev,
                a.eat("}")); null != (l = a.next()); ) {
                    if (l == e && (n || !c)) {
                        s.tokenize.pop();
                        break
        ...
        var c, u = t(["alias", "and", "BEGIN", "begin", "break", "case", "class", "def", "defined?", "do", "else", "elsif", "END", "end", "ensure", "false", "for", "if", "in", "module", "next", "not", "or", "redo", "rescue", "retry", "return", "self", "super", "then", "true", "undef", "unless", "until", "when", "while", "yield", "nil", "raise", "throw", "catch", "fail", "loop", "callcc", "caller", "lambda", "proc", "public", "protected", "private", "require", "load", "require_relative", "extend", "autoload", "__END__", "__FILE__", "__LINE__", "__dir__"]), d = t(["def", "class", "case", "for", "while", "module", "then", "catch", "loop", "proc", "begin"]), f = t(["end", "until"]), m = {
            "[": "]",
            "{": "}",
            "(": ")"
        };
        return {
            ...
            token: function(e, t) {
                ...
                if ("ident" == n) {
                    ...
                    "keyword" == n && (i = o,
                    d.propertyIsEnumerable(o) ? r = "indent" : f.propertyIsEnumerable(o) ? r = "dedent" : "if" != o && "unless" != o || e.column() != e.indentation() ? "do" == o && t.context.indented < t.indented && (r = "indent") : r = "indent")
                }
...
function(e) {
    ...
    e.defineMode("rst-base", function(t) {
        function r(e) {
        ...
        function n(t, r) {
            ...
            if (t.sol() && t.match(X, !1))
            ...
            else if (t.sol() && t.match(T))
                u(r, i),
                o = "meta";
            else if (t.sol() && t.match(S))
                u(r, n),
                o = "header";
                ...
                case 2:
                    ...
                    break;
                case 3:
                    if (r.tmp_stex && (r.tmp_stex = void 0,
                    r.tmp = {
                        mode: h,
        ...
        function i(t, r) {
            ...
            if (f(r) == E || t.match(E, !1))
                ...
                case 1:
                    ...
                    t.match(H),
                    a = "meta",
                    (t.match(/^latex\s*$/) || r.tmp_stex) && (r.tmp_stex = void 0,
                    u(r, l, {
                        mode: h,
                        local: e.startState(h)
                    }));
                ...
                case 2:
                    u(r, i, c(L, 3)),
                    (t.match(/^python\s*$/) || r.tmp_py) && (r.tmp_py = void 0,
                    u(r, l, {
                        mode: m,
                        local: e.startState(m)
                    }));
                ...
                t.match(q) ? (u(r, n),
                a = "quote") : t.match(j) ? (u(r, n),
                a = "quote") : (t.eatSpace(),
                t.eol() ? u(r, n) : (t.skipToEnd(),
                u(r, o),
                a = "comment"));
            return a
        }
        ...
        function s(e, t, r) {
            return e.eol() || e.eatSpace() ? (e.skipToEnd(),
            r) : (u(t, n),
            null)
        }
        function l(e, t) {
            return t.ctx.mode && t.ctx.local ? e.sol() ? (e.eatSpace() || u(t, n),
            null) : t.ctx.mode.token(e, t.ctx.local) : (u(t, n),
            null)
        }
        function c(e, t, r, n) {
            return {
        ...
        var a = r(o.leftDelimiter)
          ...
          , u = {
            html: function(e, t) {
                ...
                return !t.inLiteral && e.match(l.htmlHasLeftDelimeter, !1) && null === r ? (t.tokenize = u.smarty,
                t.localMode = i,
                t.localState = i.startState(n.indent(t.htmlMixedState, "")),
                c.maybeBackup(e, o.leftDelimiter, i.token(e, t.localState))) : !t.inLiteral && e.match(o.leftDelimiter, !1) ? (t.tokenize = u.smarty,
                t.localMode = i,
                t.localState = i.startState(n.indent(t.htmlMixedState, "")),
                c.maybeBackup(e, o.leftDelimiter, i.token(e, t.localState))) : n.token(e, t.htmlMixedState)
            },
            smarty: function(e, t) {
                if (e.match(o.leftDelimiter, !1)) {
                    if (e.match(l.smartyComment, !1))
                        return c.chain(e, t, u.inBlock("comment", "*" + o.rightDelimiter))
                } else if (e.match(o.rightDelimiter, !1))
                    return e.eat(o.rightDelimiter),
                    t.tokenize = u.html,
                    t.localMode = n,
            ...
            token: function(e, t) {
                if (e.match(o.leftDelimiter, !1)) {
                    if (!t.inLiteral && e.match(l.literalOpen, !0))
                        return t.inLiteral = !0,
                        "keyword";
                    if (t.inLiteral && e.match(l.literalClose, !0))
                        return t.inLiteral = !1,
                        "keyword"
                }
                t.inLiteral && t.localState != t.htmlMixedState && (t.tokenize = u.html,
                t.localMode = n,
                t.localState = t.htmlMixedState);
    ...
    e.defineMode("vb", function(e, t) {
        ...
        function o(e, t) {
            ...
            if (e.match(/^((&H)|(&O))?[0-9\.a-f]/i, !1)) {
                var o = !1;
                if (e.match(/^\d*\.\d+F?/i) ? o = !0 : e.match(/^\d+\.\d*F?/) ? o = !0 : e.match(/^\.\d+F?/) && (o = !0),
                o)
                    return e.eat(/J/i),
                    "number";
                var s = !1;
                if (e.match(/^&H[0-9a-f]+/i) ? s = !0 : e.match(/^&O[0-7]+/i) ? s = !0 : e.match(/^[1-9]\d*F?/) ? (e.eat(/J/i),
                s = !0) : e.match(/^0(?![\dx])/i) && (s = !0),
                s)
                    return e.eat(/L/i),
                    "number"
            }
            return e.match(_) ? (t.tokenize = a(e.current()),
            t.tokenize(e, t)) : e.match(m) || e.match(f) ? null : e.match(d) || e.match(c) || e.match(b) ? "operator" : e.match(u) ? null : e.match(L) ? (n(e, t),
            t.doInCurrentLine = !0,
            "keyword") : e.match(C) ? (t.doInCurrentLine ? t.doInCurrentLine = !1 : n(e, t),
            "keyword") : e.match(S) ? "keyword" : e.match(M) ? (i(e, t),
            i(e, t),
            "keyword") : e.match(T) ? (i(e, t),
            "keyword") : e.match(w) ? "keyword" : e.match(k) ? "keyword" : e.match(h) ? "variable" : (e.next(),
            l)
        }
        function a(e) {
            var r = 1 == e.length
    ...
    e.defineMode("vbscript", function(e, t) {
        ...
        function o(e, t) {
            ...
            if (e.match(/^((&H)|(&O))?[0-9\.]/i, !1) && !e.match(/^((&H)|(&O))?[0-9\.]+[a-z_]/i, !1)) {
                var o = !1;
                if (e.match(/^\d*\.\d+/i) ? o = !0 : e.match(/^\d+\.\d*/) ? o = !0 : e.match(/^\.\d+/) && (o = !0),
                o)
                    return e.eat(/J/i),
                    "number";
                var s = !1;
            ...
            return e.match(P) ? (t.tokenize = a(e.current()),
            t.tokenize(e, t)) : e.match(u) || e.match(c) || e.match(v) ? "operator" : e.match(d) ? null : e.match(f) ? "bracket" : e.match(F) ? (t.doInCurrentLine = !0,
            "keyword") : e.match(R) ? (n(e, t),
            t.doInCurrentLine = !0,
            "keyword") : e.match(D) ? (t.doInCurrentLine ? t.doInCurrentLine = !1 : n(e, t),
            "keyword") : e.match(A) ? "keyword" : e.match(O) ? (i(e, t),
            i(e, t),
            "keyword") : e.match($) ? (t.doInCurrentLine ? t.doInCurrentLine = !1 : i(e, t),
            "keyword") : e.match(E) ? "keyword" : e.match(q) ? "atom" : e.match(I) ? "variable-2" : e.match(j) ? "builtin" : e.match(z) ? "variable-2" : e.match(m) ? "variable" : (e.next(),
            l)
        }
        function a(e) {
            var r = 1 == e.length
        ...
        function s(e, t) {
            var r = t.tokenize(e, t)
              , n = e.current();
            return "." === n ? (r = t.tokenize(e, t),
            n = e.current(),
            !r || "variable" !== r.substr(0, 8) && "builtin" !== r && "keyword" !== r ? l : (("builtin" === r || "keyword" === r) && (r = "variable"),
...
function(e) {
    ...
    e.defineMode("velocity", function() {
        ...
        function r(e, r) {
            ...
            if ('"' != d) {
                if (/[\[\]{}\(\),;\.]/.test(d))
                    return "(" == d && u ? r.inParams = !0 : ")" == d && (r.inParams = !1,
                ...
                if ("#" == d && e.eat("#"))
                    ...
                    "comment";
                if ("$" == d)
                    return e.eatWhile(/[\w\d\$_\.{}]/),
                    l && l.propertyIsEnumerable(e.current()) ? "keyword" : (r.lastTokenWasBuiltin = !0,
                    r.beforeParams = !0,
                    "builtin");
                if (c.test(d))
                    return r.lastTokenWasBuiltin = !1,
                ...
                e.eatWhile(/[\w\$_{}@]/);
                var f = e.current();
                return a && a.propertyIsEnumerable(f) ? "keyword" : s && s.propertyIsEnumerable(f) || e.current().match(/^#@?[a-z0-9_]+ *$/i) && "(" == e.peek() && (!s || !s.propertyIsEnumerable(f.toLowerCase())) ? (r.beforeParams = !0,
                r.lastTokenWasBuiltin = !1,
                "keyword") : r.inString ? (r.lastTokenWasBuiltin = !1,
                "string") : e.pos > f.length && "." == e.string.charAt(e.pos - f.length - 1) && r.lastTokenWasBuiltin ? "builtin" : (r.lastTokenWasBuiltin = !1,
                null)
            }
            return r.lastTokenWasBuiltin = !1,
            r.inString ? (r.inString = !1,
            "string") : r.inParams ? t(e, r, n(d)) : void 0
        }
        function n(e) {
            return function(t, n) {
    ...
    e.defineMode("xquery", function() {
        ...
        function r(r, s) {
            ...
            if ("}" == f)
                ...
                e("", null);
            if (d(s))
                return ">" == f ? e("tag", "tag") : "/" == f && r.eat(">") ? (b(s),
                e("tag", "tag")) : e("word", "variable");
            if (/\d/.test(f))
                return r.match(/^\d*(?:\.\d*)?(?:E[+\-]?\d+)?/),
                e("number", "atom");
            if ("(" === f && r.eat(":"))
                return v(s, {
                    type: "comment"
            ...
            if (g || '"' !== f && "'" !== f) {
                ...
                m(s) ? (b(s),
                e("word", "variable", S)) : (("element" == S || "attribute" == S || "axis_specifier" == _.type) && v(s, {
                    type: "xmlconstructor"
                }),
        ...
        function a(t, n) {
            return function(i, o) {
                ...
                i.eat(">") ? (o.tokenize = r,
                e("tag", "tag")) : (o.tokenize = s,
                e("tag", "tag")))
            }
        }
        function s(n, o) {
            var a = n.next();
            return "/" == a && n.eat(">") ? (f(o) && b(o),
            d(o) && b(o),
            e("tag", "tag")) : ">" == a ? (f(o) && b(o),
            e("tag", "tag")) : "=" == a ? e("", null) : '"' == a || "'" == a ? t(n, o, i(a, s)) : (f(o) || v(o, {
                type: "attribute",
                tokenize: s
            }),
            n.eat(/[a-zA-Z_:]/),
        ...
        var y, x, k = function() {
            ...
            for (var t = e("keyword a"), r = e("keyword b"), n = e("keyword c"), i = e("operator"), o = {
                ...
                "fn:false()": o,
                "fn:true()": o
            }, c = ["after", "ancestor", "ancestor-or-self", "and", "as", "ascending", "assert", "attribute", "before", "by", "case", "cast", "child", "comment", "declare", "default", "define", "descendant", "descendant-or-self", "descending", "document", "document-node", "element", "else", "eq", "every", "except", "external", "following", "following-sibling", "follows", "for", "function", "if", "import", "in", "instance", "intersect", "item", "let", "module", "namespace", "node", "node", "of", "only", "or", "order", "parent", "precedes", "preceding", "preceding-sibling", "processing-instruction", "ref", "return", "returns", "satisfies", "schema", "schema-element", "self", "some", "sortby", "stable", "text", "then", "to", "treat", "typeswitch", "union", "variable", "version", "where", "xquery", "empty-sequence"], u = 0, d = c.length; d > u; u++)
                l[c[u]] = e(c[u]);
            for (var f = ["xs:string", "xs:float", "xs:decimal", "xs:double", "xs:integer", "xs:boolean", "xs:date", "xs:dateTime", "xs:time", "xs:duration", "xs:dayTimeDuration", "xs:time", "xs:yearMonthDuration", "numeric", "xs:hexBinary", "xs:base64Binary", "xs:anyURI", "xs:QName", "xs:byte", "xs:boolean", "xs:anyURI", "xf:yearMonthDuration"], u = 0, d = f.length; d > u; u++)
                l[f[u]] = o;
            for (var m = ["eq", "ne", "lt", "le", "gt", "ge", ":=", "=", ">", ">=", "<", "<=", ".", "|", "?", "and", "or", "div", "idiv", "mod", "*", "/", "+", "-"], u = 0, d = m.length; d > u; u++)
                l[m[u]] = i;
            for (var h = ["self::", "attribute::", "child::", "descendant::", "descendant-or-self::", "parent::", "ancestor::", "ancestor-or-self::", "following::", "preceding::", "following-sibling::", "preceding-sibling::"], u = 0, d = h.length; d > u; u++)
                l[h[u]] = s;
            return l
        }();
        return {
    ...
    e.defineMode("yaml", function() {
        ...
        return {
            token: function(e, r) {
                ...
                if (e.match(/^(\{|\}|\[|\])/))
                    return "{" == n ? r.inlinePairs++ : "}" == n ? r.inlinePairs-- : "[" == n ? r.inlineList++ : r.inlineList--,
                    "meta";
                ...
                return !r.pair && e.match(/^\s*(?:[,\[\]{}&*!|>'"%@`][^\s'":]|[^,\[\]{}#&*!|>'"%@`])[^#]*?(?=\s*:($|\s))/) ? (r.pair = !0,
                r.keyCol = e.indentation(),
                "atom") : r.pair && e.match(/^:\s*/) ? (r.pairStart = !0,
                "meta") : (r.pairStart = !1,
                r.escaped = "\\" == n,
                e.next(),
                null)
...
function(e) {
    ...
    e.defineMode("erlang", function(t) {
        function r(e, t) {
            if (t.in_string)
                return t.in_string = !o(e),
                u(t, e, "string");
            if (t.in_atom)
                return t.in_atom = !a(e),
                u(t, e, "atom");
            if (e.eatSpace())
                return u(t, e, "whitespace");
            if (!h(t) && e.match(/-\s*[a-z?-??-?][\w?-T¨¤-??-??-?]*/))
            ...
            if ("#" == r)
                ...
                u(t, e, "record");
            if ("$" == r)
                return "\\" != e.next() || e.match(F) ? u(t, e, "number") : u(t, e, "error");
            if ("." == r)
                return u(t, e, "dot");
            if ("'" == r) {
                if (!(t.in_atom = !a(e))) {
            ...
            var d = /[0-9]/
              , f = /[0-9a-zA-Z]/;
            return d.test(r) ? (e.eatWhile(d),
            e.eat("#") ? e.eatWhile(f) || e.backUp(1) : e.eat(".") && (e.eatWhile(d) ? e.eat(/[eE]/) && (e.eat(/[-+]/) ? e.eatWhile(d) || e.backUp(2) : e.eatWhile(d) || e.backUp(1)) : e.backUp(1)),
            u(t, e, "number")) : n(e, I, P) ? u(t, e, "open_paren") : n(e, D, A) ? u(t, e, "close_paren") : i(e, L, E) ? u(t, e, "separator") : i(e, j, z) ? u(t, e, "operator") : u(t, e, null)
        }
        function n(e, t, r) {
        ...
        function p(e, t) {
            "comment" != t.type && "whitespace" != t.type && (e.tokenStack = g(e.tokenStack, t),
        ...
        function y(r, n) {
            ...
            return r.in_string || r.in_atom ? e.Pass : l ? "when" == s.token ? s.column + o : "when" === a && "function" === l.type ? l.indent + o : "(" === a && "fun" === s.token ? s.column + 3 : "catch" === a && (i = _(r, ["try"])) ? i.column : c(a, ["end", "after", "of"]) ? (i = _(r, ["begin", "case", "fun", "if", "receive", "try"]),
            i ? i.column : e.Pass) : c(a, A) ? (i = _(r, P),
            i ? i.column : e.Pass) : c(s.token, [",", "|", "||"]) || c(a, [",", "|", "||"]) ? (i = k(r),
            i ? i.column + i.token.length : o) : "->" == s.token ? c(l.token, ["receive", "case", "if", "try"]) ? l.column + o + o : l.column + o : c(s.token, P) ? s.column + s.token.length : (i = w(r),
            S(i) ? i.column + o : 0) : 0
        }
        function x(e) {
            var t = e.match(/,|[a-z]+|\}|\]|\)|>>|\|+|\(/);
    ...
    e.defineMode("jade", function(t) {
        ...
        function i(e, t) {
            if (t.javaScriptArguments) {
                ...
                if ("(" === e.peek() ? t.javaScriptArgumentsDepth++ : ")" === e.peek() && t.javaScriptArgumentsDepth--,
        ...
        function s(e, t) {
            return e.match("#{") ? (t.isInterpolating = !0,
        ...
        function l(e, t) {
            if (t.isInterpolating) {
                if ("}" === e.peek()) {
                    if (t.interpolationNesting--,
                    t.interpolationNesting < 0)
                        return e.next(),
                        t.isInterpolating = !1,
                        "puncutation"
                } else
                    "{" === e.peek() && t.interpolationNesting++;
                return Q.token(e, t.jsState) || !0
            }
        }
        function c(e, t) {
            return e.match(/^case\b/) ? (t.javaScriptLine = !0,
            V) : void 0
        }
        function u(e, t) {
            return e.match(/^when\b/) ? (t.javaScriptLine = !0,
        ...
        function f(e, t) {
            return e.match(/^extends?\b/) ? (t.restOfLine = "string",
            V) : void 0
        }
        function m(e, t) {
            return e.match(/^append\b/) ? (t.restOfLine = "variable",
            V) : void 0
        }
        function h(e, t) {
            return e.match(/^prepend\b/) ? (t.restOfLine = "variable",
            V) : void 0
        }
        function p(e, t) {
            return e.match(/^block\b *(?:(prepend|append)\b)?/) ? (t.restOfLine = "variable",
            V) : void 0
        }
        function g(e, t) {
            return e.match(/^include\b/) ? (t.restOfLine = "string",
            V) : void 0
        }
        function v(e, t) {
            return e.match(/^include:([a-zA-Z0-9\-]+)/, !1) && e.match("include") ? (t.isIncludeFiltered = !0,
            V) : void 0
        }
        function b(e, t) {
        ...
        function y(e, t) {
            return e.match(/^mixin\b/) ? (t.javaScriptLine = !0,
            V) : void 0
        }
        function x(e, t) {
            return e.match(/^\+([-\w]+)/) ? (e.match(/^\( *[-\w]+ *=/, !1) || (t.javaScriptArguments = !0,
            t.javaScriptArgumentsDepth = 0),
            "variable") : e.match(/^\+#{/, !1) ? (e.next(),
            t.mixinCallAfter = !0,
            s(e, t)) : void 0
        }
        function k(e, t) {
            return t.mixinCallAfter ? (t.mixinCallAfter = !1,
            e.match(/^\( *[-\w]+ *=/, !1) || (t.javaScriptArguments = !0,
            t.javaScriptArgumentsDepth = 0),
            !0) : void 0
        }
        function w(e, t) {
            return e.match(/^(if|unless|else if|else)\b/) ? (t.javaScriptLine = !0,
            V) : void 0
        }
        function _(e, t) {
            return e.match(/^(- *)?(each|for)\b/) ? (t.isEach = !0,
            V) : void 0
        }
        function C(e, t) {
            if (t.isEach) {
                if (e.match(/^ in\b/))
                    return t.javaScriptLine = !0,
                    t.isEach = !1,
                    V;
                if (e.sol() || e.eol())
                    t.isEach = !1;
        ...
        function S(e, t) {
            return e.match(/^while\b/) ? (t.javaScriptLine = !0,
            V) : void 0
        }
        function T(e, t) {
            var r;
            return (r = e.match(/^(\w(?:[-:\w]*\w)?)\/?/)) ? (t.lastTag = r[1].toLowerCase(),
        ...
        function L(e, t) {
            return e.match(/^(!?=|-)/) ? (t.javaScriptLine = !0,
            "punctuation") : void 0
        }
        function E(e) {
        ...
        function z(e, t) {
            if (t.isAttrs) {
                if (X[e.peek()] && t.attrsNest.push(X[e.peek()]),
                ...
                if (t.inAttributeName && e.match(/^[^=,\)!]+/))
                    return ("=" === e.peek() || "!" === e.peek()) && (t.inAttributeName = !1,
                    t.jsState = Q.startState(),
                    "script" === t.lastTag && "type" === e.current().trim().toLowerCase() ? t.attributeIsType = !0 : t.attributeIsType = !1),
                    "attribute";
                var r = Q.token(e, t.jsState);
                if (t.attributeIsType && "string" === r && (t.scriptType = e.current().toString()),
        ...
        function I(e, t) {
            return e.match(/^&attributes\b/) ? (t.javaScriptArguments = !0,
            t.javaScriptArgumentsDepth = 0,
            "keyword") : void 0
        }
        function P(e) {
        ...
        function H(e, t, r) {
            return e.indentation() > t.indentOf || t.innerModeForLine && !e.sol() || r ? t.innerMode ? (t.innerState || (t.innerState = t.innerMode.startState ? t.innerMode.startState(e.indentation()) : {}),
            e.hideFirstChars(t.indentOf + 2, function() {
                return t.innerMode.token(e, t.innerState) || !0
            })) : (e.skipToEnd(),
            t.indentToken) : void (e.sol() && (t.indentOf = 1 / 0,
            t.indentToken = null,
            t.innerMode = null,
            t.innerState = null))
        }
        function N(e, t) {
            if (e.sol() && (t.restOfLine = ""),
            t.restOfLine) {
                e.skipToEnd();
                var r = t.restOfLine;
                return t.restOfLine = "",
