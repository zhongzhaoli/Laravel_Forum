...
function(e) {
    ...
    e.defineExtension("openDialog", function(o, r, n) {
        ...
        n || (n = {}),
        i(this, null);
        var s, l = t(this, o, n.bottom), c = !1, d = this, h = l.getElementsByTagName("input")[0];
        return h ? (n.value && (h.value = n.value,
        h.select()),
        n.onInput && e.on(h, "input", function(e) {
        ...
        e.on(h, "keydown", function(t) {
            n && n.onKeyDown && n.onKeyDown(t, h.value, a) || ((27 == t.keyCode || n.closeOnEnter !== !1 && 13 == t.keyCode) && (h.blur(),
            e.e_stop(t),
            a()),
            13 == t.keyCode && r(h.value, t))
        }),
        n.closeOnBlur !== !1 && e.on(h, "blur", a),
        h.focus()) : (s = l.getElementsByTagName("button")[0]) && (e.on(s, "click", function() {
            a(),
            d.focus()
        }),
    ...
    e.defineExtension("openNotification", function(o, r) {
        ...
        i(this, n);
        var a, s = t(this, o, r && r.bottom), l = !1, c = r && "undefined" != typeof r.duration ? r.duration : 5e3;
...
function(e) {
        ...
        "string" != typeof t)
            ...
            if (1 == l.length)
                ...
                this.matches = function(t, i) {
                    var r = l.length - 1;
                    if (t) {
                        if (i.line - (l.length - 1) < e.firstLine())
                            return;
                        if (s(e.getLine(i.line).slice(0, c[r].length)) != l[l.length - 1])
                            return;
                        for (var n = o(i.line, c[r].length), a = i.line - 1, d = r - 1; d >= 1; --d,
                        --a)
                            if (l[d] != s(e.getLine(a)))
                                return;
                        var h = e.getLine(a)
                    ...
                    if (!(i.line + (l.length - 1) > e.lastLine())) {
                        var h = e.getLine(i.line)
                          , u = h.length - c[0].length;
                        if (s(h.slice(u)) == l[0]) {
                            for (var f = o(i.line, u), a = i.line + 1, d = 1; r > d; ++d,
                            ++a)
                                if (l[d] != s(e.getLine(a)))
                                    return;
    ...
    e.defineExtension("selectMatches", function(t, i) {
        for (var o, r = [], n = this.getSearchCursor(t, this.getCursor("from"), i); (o = n.findNext()) && !(e.cmpPos(n.to(), this.getCursor("to")) > 0); )
            r.push({
                anchor: n.from(),
                head: n.to()
            });
...
function(e) {
    ...
    function t(e, t) {
        return "string" == typeof e ? e = new RegExp(e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"),t ? "gi" : "g") : e.global || (e = new RegExp(e.source,e.ignoreCase ? "gi" : "g")),
        {
            token: function(t) {
                ...
                return i && i.index == t.pos ? (t.pos += i[0].length,
                "searching") : void (i ? t.pos = i.index : t.skipToEnd())
            }
        }
    }
    function i() {
    ...
    function d(t, i) {
        t.operation(function() {
            ...
            (a.find(i) || (a = n(t, r.query, i ? e.Pos(t.lastLine()) : e.Pos(t.firstLine(), 0)),
            a.find(i))) && (t.setSelection(a.from(), a.to()),
            t.scrollIntoView({
                from: a.from(),
                to: a.to()
            }),
            ...
            a(e, p, "Replace with:", "", function(o) {
                if (t)
                    ...
                    var r = n(e, i, e.getCursor())
                      , a = function() {
                        var t, o = r.from();
                        !(t = r.findNext()) && (r = n(e, i),
                        !(t = r.findNext()) || o && r.from().line == o.line && r.from().ch == o.ch) || (e.setSelection(r.from(), r.to()),
                        e.scrollIntoView({
                            from: r.from(),
                            to: r.to()
                        }),
    ...
    t.prototype.redraw = function(e) {
        ...
        if (t.display.barWidth)
            for (var n, a = 0; a < r.length; a++) {
                for (var s = r[a], l = n || t.charCoords(s.from, "local").top * i, c = t.charCoords(s.to, "local").bottom * i; a < r.length - 1 && (n = t.charCoords(r[a + 1].from, "local").top * i,
                !(n > c + .9)); )
                    s = r[++a],
...
function(e) {
    ...
    t.prototype.onChange = function(t) {
        var o = t.from.line
          ...
          , n = r - t.to.line;
        if (this.gap ? (this.gap.from = Math.min(i(this.gap.from, o, n), t.from.line),
        this.gap.to = Math.max(i(this.gap.to, o, n), t.from.line)) : this.gap = {
            from: t.from.line,
            to: r + 1
        },
        n)
...
function(e) {
    ...
    function r(e) {
        var o = e.getWrapperElement()
          , r = n(e);
        o.className = o.className.replace(" CodeMirror-empty", "") + (r ? " CodeMirror-empty" : ""),
        r ? i(e) : t(e)
    }
    function n(e) {
...
function(e) {
    ...
    function t(t) {
        ...
        for (var i = t.listSelections(), o = [], l = 0; l < i.length; l++) {
            ...
            var w = v.toLowerCase();
            if (!v || "string" == d.type && (d.end != c.ch || !/[\"\']/.test(d.string.charAt(d.string.length - 1)) || 1 == d.string.length) || "tag" == d.type && "closeTag" == u.type || d.string.indexOf("/") == d.string.length - 1 || p && r(p, w) > -1 || n(t, v, c, u, !0))
                return e.Pass;
            var b = m && r(m, w) > -1;
            o[l] = {
                indent: b,
        ...
        for (var l = i.length - 1; l >= 0; l--) {
            ...
            t.setSelections(k),
            y.indent && (t.indentLine(y.newPos.line, null, !0),
    ...
    function i(t, i) {
        for (var o = t.listSelections(), r = [], a = i ? "/" : "</", s = 0; s < o.length; s++) {
            ...
            var l = o[s].head
              ...
              , h = d.state;
            if (i && ("string" == c.type || "<" != c.string.charAt(0) || c.start != l.ch - 1))
                return e.Pass;
            if ("xml" != d.mode.name)
        ...
        for (var s = 0; s < o.length; s++)
            (s == o.length - 1 || o[s].head.line < o[s + 1].head.line) && t.indentLine(o[s].head.line)
    }
    function o(t) {
    ...
    e.defineOption("autoCloseTags", !1, function(i, r, n) {
        if (n != e.Init && n && i.removeKeyMap("autoCloseTags"),
        r) {
            var a = {
                name: "autoCloseTags"
            };
...
function(e) {
    ...
    function o(e, t) {
        for (var i = e.findMarksAt(h(t)), o = 0; o < i.length; ++o)
            if (i[o].__isFold && i[o].find().from.line == t)
                return !0
    }
    function r(e) {
        if ("string" == typeof e) {
        ...
        if (t) {
            ...
            t.changeUpdate = setTimeout(function() {
                ...
                t.from == t.to || i.from - t.to > 20 || t.from - i.to > 20 ? a(e) : e.operation(function() {
                    i.from < t.from && (n(e, i.from, t.from),
                    t.from = i.from),
                    i.to > t.to && (n(e, t.to, i.to),
                    t.to = i.to)
                })
    ...
    e.defineOption("foldGutter", !1, function(o, r, n) {
        n && n != e.Init && (o.clearGutter(o.state.foldGutter.options.gutter),
        ...
        o.off("unfold", d),
        o.off("swapDoc", a)),
        r && (o.state.foldGutter = new t(i(r)),
        a(o),
        o.on("gutterClick", s),
        o.on("change", l),
...
function(e) {
    ...
    e.registerHelper("fold", "brace", function(t, i) {
        function o(o) {
            for (var r = i.ch, l = 0; ; ) {
                ...
                if (-1 != c) {
                    if (1 == l && c < i.ch)
                        break;
                    if (n = t.getTokenTypeAt(e.Pos(a, c + 1)),
        ...
        var r, n, a = i.line, s = t.getLine(a), l = "{", c = "}", r = o("{");
        if (null == r && (l = "[",
        c = "]",
        r = o("[")),
        null != r) {
            var d, h, u = 1, f = t.lastLine();
            e: for (var g = a; f >= g; ++g)
    ...
    e.registerHelper("fold", "import", function(t, i) {
        function o(i) {
            ...
            if (/\S/.test(o.string) || (o = t.getTokenAt(e.Pos(i, o.end + 1))),
...
function(e) {
    ...
    function r(e) {
        return e.line >= e.max ? void 0 : (e.ch = 0,
        e.text = e.cm.getLine(++e.line),
        !0)
    }
    function n(e) {
        return e.line <= e.min ? void 0 : (e.text = e.cm.getLine(--e.line),
        e.ch = e.text.length,
        !0)
    }
    function a(e) {
    ...
    function d(e, t) {
        for (var i = []; ; ) {
            var o, r = l(e), n = e.line, s = e.ch - (r ? r[0].length : 0);
            if (!r || !(o = a(e)))
                return;
            if ("selfClose" != o)
                if (r[1]) {
...
function(e) {
    ...
    e.registerHelper("fold", "markdown", function(t, i) {
        ...
        function r(e, t, i) {
            var r = t && t.match(/^#+/);
            return r && o(e) ? r[0].length : (r = i && i.match(/^[=\-]+\s*$/),
            r && o(e + 1) ? "=" == i[0] ? 1 : 2 : n)
        }
        var n = 100
          , a = t.getLine(i.line)
        ...
        if (l === n)
            return void 0;
        for (var c = t.lastLine(), d = i.line, h = t.getLine(d + 2); c > d && !(r(d + 1, s, h) <= l); )
            ++d,
            s = h,
            h = t.getLine(d + 2);
        return {
...
function(e) {
    ...
    e.defineOption("styleActiveLine", !1, function(i, n, a) {
        var s = a && a != e.Init;
        n && !s ? (i.state.activeLines = [],
        o(i, i.listSelections()),
        i.on("beforeSelectionChange", r)) : !n && s && (i.off("beforeSelectionChange", r),
        t(i),
...
function(e) {
    ...
    function o(o, r) {
        for (var n = {
            ...
            (function(t, o) {
                a += o,
                n["'" + t + "'"] = function(n) {
                    if (n.getOption("disableInput"))
                        return e.Pass;
                    for (var s, d, h = n.listSelections(), u = 0; u < h.length; u++) {
                        var f, g = h[u], p = g.head, d = n.getRange(p, c(p.line, p.ch + 1));
                        if (g.empty())
                            if (t == o && d == o)
                                f = n.getRange(p, c(p.line, p.ch + 3)) == t + t + t ? "skipThree" : "skip";
                            else if (t == o && p.ch > 1 && r.indexOf(t) >= 0 && n.getRange(c(p.line, p.ch - 2), p) == t + t && (p.ch <= 2 || n.getRange(c(p.line, p.ch - 3), c(p.line, p.ch - 2)) != t))
                                f = "addFour";
                            else if ('"' == t || "'" == t) {
                                ...
                                if (!(n.getLine(p.line).length == p.ch || a.indexOf(d) >= 0 || l.test(d)))
                                    return e.Pass;
                                f = "both"
                            }
                        else
                    ...
                    n.operation(function() {
                        if ("skip" == s)
                            ...
                            "both" == s ? (n.replaceSelection(t + o, null),
                            n.execCommand("goCharLeft")) : "addFour" == s && (n.replaceSelection(t + t + t + t, "before"),
                            n.execCommand("goCharRight"))
                    })
                }
                ,
                t != o && (n["'" + o + "'"] = function(t) {
                    for (var i = t.listSelections(), r = 0; r < i.length; r++) {
                        var n = i[r];
                        if (!n.empty() || t.getRange(n.head, c(n.head.line, n.head.ch + 1)) != o)
                            return e.Pass
                    }
    ...
    e.defineOption("autoCloseBrackets", !1, function(t, i, l) {
        if (l != e.Init && l && t.removeKeyMap("autoCloseBrackets"),
        i) {
            var c = n
              , d = a
              , h = s;
            "string" == typeof i ? c = i : "object" == typeof i && (null != i.pairs && (c = i.pairs),
...
function(e) {
    ...
    "use strict";
    function t(e) {
        "object" == typeof e && (this.minChars = e.minChars,
        this.style = e.style,
    ...
    function o(e) {
        e.operation(function() {
            var t = e.state.matchHighlighter;
            if (t.overlay && (e.removeOverlay(t.overlay),
            t.overlay = null),
            !e.somethingSelected() && t.showToken) {
                for (var i = t.showToken === !0 ? /[\w$]/ : t.showToken, o = e.getCursor(), n = e.getLine(o.line), s = o.ch, l = s; s && i.test(n.charAt(s - 1)); )
                    --s;
                for (; l < n.length && i.test(n.charAt(l)); )
                    ++l;
    ...
    function a(e, t, i) {
        return {
            token: function(o) {
                return !o.match(e) || t && !n(o, t) ? (o.next(),
                void (o.skipTo(e.charAt(0)) || o.skipToEnd())) : i
            }
        }
    }
    var s = 2
    ...
    e.defineOption("highlightSelectionMatches", !1, function(r, n, a) {
        ...
        n && (r.state.matchHighlighter = new t(n),
        o(r),
